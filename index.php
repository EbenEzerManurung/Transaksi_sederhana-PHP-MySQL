...
<div class="row">
  ...
  <div class="col-sm-4 col-md-4 col-lg-3 mb-3">
    ...
    <input type="text" name="Ckdproduk" placeholder="ketik kode produk..." class="form-control form-control-sm" list="datalist1" onchange="changeValue(this.value)" required autofocus>
...
while($d = mysqli_fetch_array($data_cart)){
  ...
  <tr>
    ...
    <td> <a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#Delete<?php echo $d['idcart']; ?>">
      ...
      <!-- Modal Delete -->
  <div class="modal fade" id="Delete<?php echo $d['idcart']; ?>" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      <i class="fas fa-exclamation-triangle fa-4x text-warning mb-3"></i>
        ...
        <a href="?hapus=<?php echo $d['idcart']; ?>"  class="btn btn-danger px-4">Hapus</a>
